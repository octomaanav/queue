...
//     try{
//         const client = createClient("https://ijcorhcaxkyxheioiqti.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlqY29yaGNheGt5eGhlaW9pcXRpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzExNjkxMzYsImV4cCI6MjA0Njc0NTEzNn0.a5jb9HY-Sx6u4AgpxM9ctTtTfD44DVOuSHYjT3wH3Us", {
//             global:{
//                 headers:{
...
//         return client
//     }catch(error){
//         console.error("Error while initializing supabase client", error);
//         return null;
//     }
